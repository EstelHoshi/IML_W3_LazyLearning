...
@cli.command('kNN')
@click.option('-d', '--dataset', nargs=2, type=Choice(['kropt', 'satimage', 'credita']), 
              default=('satimage', 0), help='Dataset name')
...
def kNN_credita(k, similarity, policy, weighting):
